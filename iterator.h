...
inline void distance(RandomAccessIterator first, RandomAccessIterator last,
...
class reverse_iterator {
   ...
   public:
    ...
    friend bool operator==(const reverse_iterator<RandomAccessIterator> &lhs,
                           const reverse_iterator<RandomAccessIterator> &rhs) {
    ...
    friend difference_type operator-(
        const reverse_iterator<RandomAccessIterator> &lhs,
        const reverse_iterator<RandomAccessIterator> &rhs) {
        return rhs.current - lhs.current;
    }
    friend reverse_iterator<RandomAccessIterator> operator+(
        reverse_iterator<RandomAccessIterator> n,
