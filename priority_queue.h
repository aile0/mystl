...
namespace mystl
{
    ...
    template <typename T, typename SequenceContainer>
    template <typename InputIterator>
    priority_queue<T, SequenceContainer>::priority_queue(InputIterator first, InputIterator last)
    {
    ...
    template <typename T, typename SequenceContainer>
    typename priority_queue<T, SequenceContainer>::size_type priority_queue<T, SequenceContainer>::size()
    {
        return container.size();
    }

    template <typename T, typename SequenceContainer>
    typename priority_queue<T, SequenceContainer>::reference priority_queue<T, SequenceContainer>::top()
    {
